import { AppBar, Toolbar, Typography, Card, CardContent, Grid } from '@material-ui/core';

import React from 'react';
import Postman6 from './postman6';

export default class Postman4 extends React.Component {
    render() {
        return (
            <div style={{ height: "75vh" }}>
                ...
                <div style={{ marginTop: 120 }}>
                    ...
                    <spin style={{ color: "black", marginLeft: 20 }}>get_active_domain_lesson </spin>
                    </Typography>
                </div>
                <div>
